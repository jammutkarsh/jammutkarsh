...
- [validatedev/BrewServicesManager](https://github.com/validatedev/BrewServicesManager) - A macOS menu bar app for managing Homebrew services (4 days ago)
- [nkanaev/yarr](https://github.com/nkanaev/yarr) - yet another rss reader (6 days ago)
