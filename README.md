...
- [yetone/kill-ai-slop](https://github.com/yetone/kill-ai-slop) - A field guide to the visual &amp; copy tics of AI-generated products — and an Agent Skill that scans your project and strips them out. https://killaislop.com (2 days ago)
- [modem-dev/hunk](https://github.com/modem-dev/hunk) - Review-first terminal diff viewer for agentic coders (2 days ago)
- [mozilla-ai/cq](https://github.com/mozilla-ai/cq) - An open standard for shared agent learning. Agents persist, share, and query collective knowledge so they stop rediscovering the same failures independently. (4 days ago)
- [nushell/nushell](https://github.com/nushell/nushell) - A new type of shell (4 days ago)
