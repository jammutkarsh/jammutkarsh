...
- [jammutkarsh/pr-pulse](https://github.com/jammutkarsh/pr-pulse) - PR Pulse is a Pull Request dashboard for GitHub, delivered as a Chrome extension. Say No to Navigation! (today)
...
- [tickernelz/opencode-mem](https://github.com/tickernelz/opencode-mem) - OpenCode plugin that gives coding agents persistent memory using local vector database (today)
- [cultron/becoming-martin-fowler](https://github.com/cultron/becoming-martin-fowler) - A curated collection of Martin Fowler&#39;s software engineering and architecture wisdom, organized by topic. (1 day ago)
- [Redocly/redoc](https://github.com/Redocly/redoc) - 📘  OpenAPI/Swagger-generated API Reference Documentation (1 day ago)
- [mr-karan/stakeout](https://github.com/mr-karan/stakeout) - A stakeout on your home internet — probes LAN/WAN/DNS/HTTPS from inside your network, classifies outages into evidence-backed incidents, and keeps the proof for your ISP ticket. (3 days ago)
- [RibbonFilter/ribbonGo](https://github.com/RibbonFilter/ribbonGo) - ribbon filter in golang(Go), practically smaller than Bloom and Xor (3 days ago)
